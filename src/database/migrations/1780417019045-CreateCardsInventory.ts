...
export class CreateCardsInventory1780417019045 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cards" ADD CONSTRAINT "FK_010040e63b2b829e93035964636" FOREIGN KEY ("card_type_id") REFERENCES "card_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cards" ADD CONSTRAINT "FK_019d61c2fe46dd903638ed3bfe9" FOREIGN KEY ("owner_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cards" DROP CONSTRAINT "FK_019d61c2fe46dd903638ed3bfe9"`);
        await queryRunner.query(`ALTER TABLE "cards" DROP CONSTRAINT "FK_010040e63b2b829e93035964636"`);
